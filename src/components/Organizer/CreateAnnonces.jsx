...
console.log('Token from local storage:', token);
    ...
    const submit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('http://127.0.0.1:8000/api/announcement/create', {
                method: 'POST',
                headers: {
                ...
                <div className=" w-[50%] mx-auto bg-white shadow-md rounded px-8 mt-5 pt-6 pb-8 mb-4 flex flex-col my-2">
                    <div className="-mx-3 md:flex mb-6">
                        <div className="md:w-1/2 px-3 mb-6 md:mb-0">
                            ...
                            <input onChange={e => settitle(e.target.value)} className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3"   type="text" placeholder="AA ..."/>
                        </div>
                    ...
                    <div className="-mx-3 md:flex mb-6">
                        ...
                        <div className="md:w-full px-3">
                            ...
                            <input onChange={e => setrequired_skills(e.target.value)} className="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4 mb-3" type="text" placeholder="AA ..."/>
                        </div>
                    </div>
